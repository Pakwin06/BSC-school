            ...
            <div class="box-body">
                ...
                <form accept="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="nama" placeholder="Identitas Sekolah" value="<?= $d->nama ?>" class="input-control" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="favicom_lama" value="<?= $d->favicon ?>">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($_FILES['favicon_baru']['name'] != '') {
                        ...
                        $allowedtype_favicon = array('png', 'jpg', 'jpeg', 'gif', 'ico');
                        ...
                        $rename_logo     =   $_POST['favicon_lama'];
                    }
                    ...
                    if ($update) {
                        echo "<script>window.location='identitas-sekolah.php?success=Edit Data Berhasill'</script>";
                    } else {
                        echo '<div class="alert alert-error">Gagal Ganti Data</div>' . mysqli_error($conn);
                    }
                }
