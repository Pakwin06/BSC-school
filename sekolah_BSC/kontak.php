...
<div class="section">
    <div class="container">
        ...
        <div class="col-4">
            <p style="margin-bottom:20px ;"><b>Alamat :</b> <br> <?= $d->alamat ?> </p>
            <p style="margin-bottom:20px ;"><b>Telepon :</b> <br> <?= $d->telepon ?> </p>
            <p style="margin-bottom:20px ;"><b>Email :</b> <br> <?= $d->email ?> </p>
        </div>
