   ...
   <div class="banner" style=" background-image: url('uploads/identitas/<?= $d->foto_sekolah ?>');">
       <div class="banner-text">
           <div class="container">
               ...
               <p>Sekolah dengan berbagai jurusan yang dapat Anda pilih sesuai minat dan bakat Anda untuk mneguasai dunia bersama Bojongsari Corp.</p>
           </div>
       </div>
   </div>
   ...
   <div class="section">
       ...
       <div class="container text-center">
           ...
           <img src="uploads/identitas/<?= $d->foto_kepsek ?>" width="100" alt="">
           <h4><?= $d->nama_kepsek ?></h4>
